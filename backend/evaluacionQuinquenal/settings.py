...
SECRET_KEY = os.getenv(
    'SECRET_KEY',
    'django-insecure-cambiar-en-produccion-w@ii_-rppf_7)*7u10w!cfz!u*lu^$g$0souiqh6!oy42m(73z'
)
...
CORS_ALLOWED_ORIGINS = [
    ...
    for origin in os.getenv(
        'CORS_ALLOWED_ORIGINS',
        'http://localhost:4200,http://localhost,http://frontend,http://frontend:4200'
    ).split(',')
    if origin.strip()
]
